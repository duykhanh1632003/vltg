...
describe("Kiểm tra hàm ntdXemUv", () => {
  ...
  it("XUV_TC01 - Trả lỗi nếu không tìm thấy nhà tuyển dụng", async () => {
  ...
  it("XUV_TC02 - Trả lỗi nếu thiếu id ứng viên", async () => {
    req.body.id_uv = null;
  ...
  it("XUV_TC03 - Trả lỗi nếu không tìm thấy ứng viên", async () => {
    Users.findOne
  ...
  it("XUV_TC04 - Trả lỗi nếu đã xem ứng viên trước đó", async () => {
    Users.findOne
  ...
  it("XUV_TC05 - Trả lỗi nếu nhà tuyển dụng không đủ điểm", async () => {
    Users.findOne
  ...
  it("XUV_TC06 - Trả lỗi nếu lưu thông tin xem thất bại", async () => {
  ...
  it("XUV_TC07 - Xem ứng viên thành công (dùng điểm miễn phí)", async () => {
    const ntd = { _id: 1, type: 1, diem_free: 1, diem_mua: 0, userName: "NTD", avatarUser: "avatar.png" };
    const uv = { _id: 2, type: 0, userName: "UV", email: "uv@gmail.com" };
  ...
  it("XUV_TC08 - Xem ứng viên thành công (dùng điểm đã mua)", async () => {
  ...
  it("XUV_TC09 - Xử lý lỗi hệ thống (bất ngờ)", async () => {
