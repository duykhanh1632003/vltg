const { dangTin } = require('../controllers/vieclamtheogio/manageAccountCompany');
...
describe('Unit Test - dangTin', () => {
  ...
  test('DT_TC01 - Không phải nhà tuyển dụng (type != 1)', async () => {
  ...
  test('DT_TC02 - Thiếu trường vi_tri', async () => {
  ...
  test('DT_TC03 - Thiếu list_ca', async () => {
  ...
  test('DT_TC04 - Tiêu đề bị trùng', async () => {
  ...
  test('DT_TC05 - Sai định dạng ngày', async () => {
    ViecLam.find.mockResolvedValue([]);
  ...
  test('DT_TC06 - Sai định dạng số điện thoại', async () => {
ViecLam.find.mockResolvedValue([]);
    ViecLam.findOne.mockResolvedValue(null);
  ...
  test('DT_TC07 - Đăng tin thành công', async () => {
    ViecLam.find.mockResolvedValue([]);
    ViecLam.findOne.mockResolvedValue(null);
    functions.checkDate.mockReturnValue(true);
  ...
  test('DT_TC08 - Nếu time_td < thời gian hiện tại', async () => {
  ...
  test('DT_TC09 - Bị giới hạn đăng tin (đăng liên tục)', async () => {
    ViecLam.find
  ...
  test('DT_TC10 - Ném lỗi exception trong try', async () => {
